		...
		<section className="max-w-[1080px] mx-auto text-white">
			...
			<div className="flex flex-col md:flex-row-reverse">
				<div className="py-4 md:py-0 w-full md:w-1/2 border border-primary flex items-center justify-center px-4 flex-col gap-4">
					...
					<span className="text-sm text-center text-white/80">
						Фонд <strong>"Ангел"</strong> с 2013 года занимается поддержкой
						людей, оказавшихся в трудных жизненных обстоятельствах. Мы оказываем
						помощь тем, кто столкнулся с непреодолимыми трудностями,
						предоставляя необходимые ресурсы, заботу и внимание. Наша цель — не
						просто помочь, но и подарить надежду на лучшее будущее, обеспечивая
						поддержку в самых непростых ситуациях.
					</span>
					<Button asChild variant="secondary">
